...
<body>
    <div>
        ...
        <main>
            ...
            <!-- action: 제출(submit) 주소. 기본값은 현재 페이지 주소 , 
                ...
                <div>
                    <label for="id">번호</label>      <!-- id는 속성 이름, name은 파라미터 이름 -->
                ...
                <div>
                    ...
                    <!--form안에서 작성된 버튼들은 form의 action 주소로 method 방식의 요청을 보냄. -->
                </div>
                </c:if>
            </form>
        </main>
    ...
    btnDelete.addEventListener('click', function(event){
    	...
    	if (check) {   // 사용자 "확인"을 선택했을 때
    		...
    		form.submit();    // 폼 양식을 서버로 제출(데이터 전송)
    	}
    }); 
    ...
    btnUpdate.addEventListener('click', function(event){
    		...
    		// (제목이나 내용 둘 중 하나라도 안 적혀있으면 안넘어가게 해주는 것)
    		// <input> title에 입력된 값.
