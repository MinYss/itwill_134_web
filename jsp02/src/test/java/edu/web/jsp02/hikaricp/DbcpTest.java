...
public class DbcpTest {
        ...
        public void testHikariCP() throws SQLException {
            ...
            config.setDriverClassName("oracle.jdbc.driver.OracleDriver");   // 연결을 맺기 위한 DB 드라이버.
            ...
            config.addDataSourceProperty("cachPrepStmt", "true");
            config.addDataSourceProperty("prepStmtCacheSize", "250");
            config.addDataSourceProperty("prepStmtCashSqlLimit", "2048");
