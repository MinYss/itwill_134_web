...
<body>
    <h1>JSP 내장 객체 vs EL 내장 개장 객체</h1>
    <%--
    ...
    JSP에서 상태 정보들을 유지하기 위해서 사용하는 객체들:
        ...
        * application: 웹 에플리케이션이 동장 중에 사용.
    ...
    <%-- ${pageScope.number2} 속성 값을 찾을 수 없음 => ${requestScope.number2} --%>       <!-- 이런식으로 속성값을 찾는것. 첫번째에서 못찾고 두번째에서 못찾으면 세번째로 가고 맞으면 값이 나오는 것,  -->
    <br/>
